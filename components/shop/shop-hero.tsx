      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-heading-1 font-heading font-bold mb-4">
            Gear for the{' '}
            <span className="text-gradient">Pursuit</span>
          </h1>
          <p className="text-lg text-muted-foreground">
            Premium apparel, digital guides, and accessories built for those who
            refuse to compromise. Every product is designed, tested, and used by
