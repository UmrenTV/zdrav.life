...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdAt: Schema.Attribute.DateTime;
    createdAtOverride: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    faqItems: Schema.Attribute.Component<'layout.faq-item', true>;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    relatedProducts: Schema.Attribute.Relation<
      ...
      'api::product.product'
    >;
    reviewsEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    enableBlog: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    enableGallery: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    maintenanceMode: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    menuItems: Schema.Attribute.Component<'shared.menu-link', true>;
    nameAccentLetterCount: Schema.Attribute.Integer &
    ...
    themeNotes: Schema.Attribute.Text;
    tiktokUrl: Schema.Attribute.String;
    twitterUrl: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    useAccentColorForName: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
...
export interface ApiVideoVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::video.video'> &
      Schema.Attribute.Private;
    platform: Schema.Attribute.String & Schema.Attribute.DefaultTo<'youtube'>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
